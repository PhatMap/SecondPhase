...
const NewCoupon = () => {
    ...
    const validateForm = () => {
        ...
        else if (percentage <= 0 || percentage >= 100) newErrors.percentage = "Phần trăm giảm giá phải lớn hơn 0 và nhỏ hơn 100";
        ...
        if (!expiry) newErrors.expiry = "Vui lòng chọn ngày hết hạn";
            ...
            if (expiryDate <= today) newErrors.expiry = "Ngày hết hạn phải lớn hơn ngày hiện tại";
        }
