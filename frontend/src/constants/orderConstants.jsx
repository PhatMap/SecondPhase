...
export const CHECK_ORDER_REVIEW_REQUEST = "CHECK_ORDER_REVIEW_REQUEST";
export const CHECK_ORDER_REVIEW_SUCCESS = "CHECK_ORDER_REVIEW_SUCCESS";
export const CHECK_ORDER_REVIEW_FAIL = "CHECK_ORDER_REVIEW_FAIL";

export const CLEAR_ERRORS = "CLEAR_ERRORS";

export const MOMO_TRANSACTION_START = "MOMO_TRANSACTION_START";
export const MOMO_TRANSACTION_SUCCESS = "MOMO_TRANSACTION_SUCCESS";
