...
export const GET_REVIEWS_IN_PRODUCT_REQUEST = 'GET_REVIEWS_IN_PRODUCT_REQUEST';
export const GET_REVIEWS_IN_PRODUCT_SUCCESS = 'GET_REVIEWS_IN_PRODUCT_SUCCESS';
export const GET_REVIEWS_IN_PRODUCT_FAIL = 'GET_REVIEWS_IN_PRODUCT_FAIL';
